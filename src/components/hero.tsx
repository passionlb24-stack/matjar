  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <Container className="py-16 text-center sm:py-20 lg:py-24">
        <div data-animate>
          <span className="inline-flex items-center gap-2 rounded-full border border-primary/15 bg-primary-soft px-4 py-1.5 text-sm font-semibold text-primary shadow-xs">
          ...
          <h1 className="mx-auto mt-6 max-w-3xl text-4xl font-extrabold leading-[1.15] tracking-tight text-balance sm:text-5xl lg:text-6xl">
            {dict.hero.title}{" "}
